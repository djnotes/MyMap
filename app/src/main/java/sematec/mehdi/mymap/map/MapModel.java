...
import sematec.mehdi.mymap.util.GoogleRetrofitGenerator;
...
public class MapModel {
    ...
    public static WebServiceInterface WebServiceInterface = GoogleRetrofitGenerator.create(WebServiceInterface.class);
